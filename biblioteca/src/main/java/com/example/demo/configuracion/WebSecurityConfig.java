	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests()
				.requestMatchers("/", "/login", "/contacto", "/contacto/**", "/adminContacto", "/adminContacto/**",
						"/solicitud/**", "/usuario", "/MisSolicitudes", "/tienda", "/tienda/**", "/css/**", "/js/**",
						"/imagenesLibros/**", "/images/**", "/registro", "/usuarios/saveNuevoUsuario",
						"/usuarios/saveNuevoUsuario/**", "/usuarios/save", "/foro", "/foro/**", "/usuario/**")
				.permitAll()
				.requestMatchers("/adminIndex", "/usuario/{idUsuario}/adminAlquiler",
						"/usuario/{idUsuario}/adminAlquiler/add", "/usuario/{idUsuario}/adminAlquiler/save",
						"/usuario/{idUsuario}/alquilar/{idLibro}", "/adminLibros/{isbnLibro}/adminEjemplares",
						"/adminLibros", "/usuario/{idUsuario}/adminAlquiler/{idAlquiler}/adminMultas",
